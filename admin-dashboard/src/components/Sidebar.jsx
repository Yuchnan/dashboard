...
const SIDEBAR_ITEMS = [
    ...
    { name: 'Products', icon: ShoppingBag, color: "#885CF6", path: "/products" },
    { name: 'Users', icon: Users, color: "#EC4899", path: "/users" },
    { name: 'Sales', icon: DollarSign, color: "#108981", path: "/sales" },
    { name: 'Orders', icon: ShoppingCart, color: "#F59E08", path: "/orders" },
